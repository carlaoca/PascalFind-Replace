unit VKY_Maestros_Detalles_Mod;

interface

uses
  Windows, Messages, SysUtils, Variants, Classes, Graphics, Controls, Forms,
  Dialogs, DBActns, ActnList, StdCtrls, Buttons, ExtCtrls, ComCtrls, Grids,
  DBGrids, DBCtrls, ImgList, Menus,
...
type
  TVKY_Maestros_Detalles_Frm = class(TVKY_Definiciones_Simples_Frm)
    grupo_cabecera: TGroupBox;
    grupo_detalles: TGroupBox;
...
var
  VKY_Maestros_Detalles_Frm: TVKY_Maestros_Detalles_Frm;
...
{$R *.dfm}
//----------------------------------------------------------------------------//
{Este procedimiento, es el ultimo ejecutado, en el OnCreate, y basicamente
lo que aqui buscamos, es acomodar, lo que no pudimos meter, genericamente en el OnCreate}
procedure TVKY_Maestros_Detalles_Frm.procedimientos_adicionales_al_crear_form();
begin
...
//----------------------------------------------------------------------------//
procedure TVKY_Maestros_Detalles_Frm.procedimientos_adicionales_al_salir();
begin
  self.liberar_footers_de_datasets();
end;
//----------------------------------------------------------------------------//
procedure TVKY_Maestros_Detalles_Frm.setear_colores_de_objetos();
var
  i:Integer;
begin
try
...
//----------------------------------------------------------------------------//
procedure TVKY_Maestros_Detalles_Frm.liberar_footers_de_datasets();
var
  i:Integer;
begin
try
...
procedure TVKY_Maestros_Detalles_Frm.determinar_si_se_puede_asentar_o_no_desde_este_Form();
begin

end;
//----------------------------------------------------------------------------//
procedure TVKY_Maestros_Detalles_Frm.recalcular_si_operacion_esta_asentada();
begin
//ejemplo, de OP.
...
//----------------------------------------------------------------------------//
procedure TVKY_Maestros_Detalles_Frm.asentar_operacion_BotonClick(Sender: TObject);
begin
//ejemplo, de OP.
//  try
//  inherited;
